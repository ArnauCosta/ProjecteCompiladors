...
public class provaParser extends Parser {
	...
	public static final int
		...
		TK_SI=52, TK_LLAVORS=53, TK_ALTRAMENT=54, TK_FSI=55, TK_EN=56, TK_PER=57, 
		TK_ID=58, TK_FINS=59, TK_FER=60, TK_FPER=61, TK_MENTRE=62, TK_FMENTRE=63, 
		TK_LLEGIR=64, TK_ESCRIURE=65, TK_ESCRIURELN=66, TK_IDENT=67;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'fsi'", "'en'", "'per'", "'id'", "'fins'", "'fer'", "'fper'", "'mentre'", 
			"'fmentre'", "'llegir'", "'escriure'", "'escriureln'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"TK_LLEGIR", "TK_ESCRIURE", "TK_ESCRIURELN", "TK_IDENT"
		};
	}
	...
	public final EstructuraGeneralContext estructuraGeneral() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 52)) & ~0x3f) == 0 && ((1L << (_la - 52)) & 62497L) != 0) );
			setState(72);
	...
	public final CondicionalContext condicional() throws RecognitionException {
		...
		try {
			...
			while (((((_la - 52)) & ~0x3f) == 0 && ((1L << (_la - 52)) & 62497L) != 0)) {
				...
				{
				setState(239);
				((CondicionalContext)_localctx).cc = sentencia();
				trad2.addAll(((CondicionalContext)_localctx).cc.trad);
				}
				}
				setState(246);
				_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					Vector<Long> subVector = new Vector<>();
					setState(250);
					match(TK_LLAVORS);
					setState(256);
					_errHandler.sync(this);
					...
					while (((((_la - 52)) & ~0x3f) == 0 && ((1L << (_la - 52)) & 62497L) != 0)) {
						...
						subVector.addAll(((CondicionalContext)_localctx).s2.trad);
						}
						}
						setState(258);
						_errHandler.sync(this);
					...
					vectorSentencies.add(subVector);
					}
					} 
				}
				setState(265);
			...
			if (_la==TK_ALTRAMENT) {
				...
				while (((((_la - 52)) & ~0x3f) == 0 && ((1L << (_la - 52)) & 62497L) != 0)) {
					...
					{
					setState(267);
					((CondicionalContext)_localctx).s3 = sentencia();
					tradEnd.addAll(((CondicionalContext)_localctx).s3.trad);
					}
					}
					setState(274);
					_errHandler.sync(this);
			...
			match(TK_FSI);
			        ...
			        for (int i = 0; i < vectorSentencies.size(); i++) {
			            ...
			            distanciaFinsFinal += ((CondicionalContext)_localctx).e2.get(i).trad.size();
			        }
			        ...
			        for (int i = 0; i < vectorSentencies.size(); i++) {
				   	...
				   	((CondicionalContext)_localctx).trad = ((CondicionalContext)_localctx).e1.trad;
			        ...
			        for (int i = 0; i < ((CondicionalContext)_localctx).e2.size(); i++) {
			            System.out.println("Distancia final: " + distanciaFinsFinal);
			            System.out.println("Expr: " + ((CondicionalContext)_localctx).e2.get(i).trad);
			            System.out.println("Trad: " + vectorSentencies.get(i));

			            _localctx.trad.add(x.GOTO);
			            salt=distanciaFinsFinal+(3L*(((CondicionalContext)_localctx).e2.size()-i));
			            _localctx.trad.add(x.nByte(salt,2));
			            _localctx.trad.add(x.nByte(salt,1));

			            _localctx.trad.addAll(((CondicionalContext)_localctx).e2.get(i).trad);
			            _localctx.trad.add(x.IFEQ);
			            ...
			            distanciaFinsFinal -= 3 + vectorSentencies.get(i).size() + ((CondicionalContext)_localctx).e2.get(i).trad.size();
			        }
	...
	public final BuclePerContext buclePer() throws RecognitionException {
		...
		try {
			...
			match(TK_PER);
			setState(281);
			((BuclePerContext)_localctx).TK_IDENT = match(TK_IDENT);
			setState(282);
			match(TK_EN);
			setState(283);
			...
			while (((((_la - 52)) & ~0x3f) == 0 && ((1L << (_la - 52)) & 62497L) != 0)) {
				...
				{
				setState(286);
				((BuclePerContext)_localctx).s = sentencia();
				trad2.addAll(((BuclePerContext)_localctx).s.trad);
				}
				}
				setState(293);
				_errHandler.sync(this);
			...
			match(TK_FPER);
			        ...
			        if (!TS.existeix((((BuclePerContext)_localctx).TK_IDENT!=null?((BuclePerContext)_localctx).TK_IDENT.getText():null))) {
			            System.out.println("No existeix: " + (((BuclePerContext)_localctx).TK_IDENT!=null?((BuclePerContext)_localctx).TK_IDENT.getText():null)); // 12 1,4
			            notifyErrorListeners(((BuclePerContext)_localctx).TK_IDENT, "Error: Variable '" + (((BuclePerContext)_localctx).TK_IDENT!=null?((BuclePerContext)_localctx).TK_IDENT.getText():null) + "' no declarada.", null);
			        } else {
			            Registre r = (Registre) TS.obtenir((((BuclePerContext)_localctx).TK_IDENT!=null?((BuclePerContext)_localctx).TK_IDENT.getText():null));
			            if (r.getTipus() != 'I'){
			                notifyErrorListeners(((BuclePerContext)_localctx).TK_IDENT, "Error: Variable '" + (((BuclePerContext)_localctx).TK_IDENT!=null?((BuclePerContext)_localctx).TK_IDENT.getText():null) + "' must be int.", null);
			            }
			            else{

			                Long adrecaTemp=x.addConstant("I",((BuclePerContext)_localctx).r.primer); //afegim a la constant pool
			                ...
			                adrecaTemp=x.addConstant("I",((BuclePerContext)_localctx).r.segon); //afegim a la constant pool
			                _localctx.trad.add(x.LDC_W);
			                _localctx.trad.add(x.nByte(adrecaTemp,2));
			                _localctx.trad.add(x.nByte(adrecaTemp,1));

			                //System.out.println(_localctx.trad);
			                _localctx.trad.add(x.IF_ICMPGE);
			                Long salt = _localctx.trad.size() + (trad2.size() + 0L) + 3L;
			                _localctx.trad.add(x.nByte(salt,2));
			                _localctx.trad.add(x.nByte(salt,1));
			                ...
			                salt=0L-(_localctx.trad.size() - 5L) ;
			                _localctx.trad.add(x.GOTO);
			                _localctx.trad.add(x.nByte(salt,2));
			                _localctx.trad.add(x.nByte(salt,1));
	...
	public static class OperacioLecturaEscrituraContext extends ParserRuleContext {
		...
		public TerminalNode TK_ESCRIURELN() { return getToken(provaParser.TK_ESCRIURELN, 0); }
	...
	public final RangContext rang() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				setState(368);
				((RangContext)_localctx).TK_ENTER = match(TK_ENTER);

				        ((RangContext)_localctx).primer =  "0";
				        ((RangContext)_localctx).segon =  (((RangContext)_localctx).TK_ENTER!=null?((RangContext)_localctx).TK_ENTER.getText():null);
			...
			case 2:
				...
				{
				setState(370);
				((RangContext)_localctx).id = match(TK_ENTER);
				setState(371);
				match(TK_COMA);
				setState(372);
				((RangContext)_localctx).id2 = match(TK_ENTER);

				        ((RangContext)_localctx).primer =  (((RangContext)_localctx).id!=null?((RangContext)_localctx).id.getText():null);
				        ((RangContext)_localctx).segon =  (((RangContext)_localctx).id2!=null?((RangContext)_localctx).id2.getText():null);
		...
		try {
			...
			default:
				break;
			        ...
			        if (((Expr2Context)_localctx).e2 == null) {
			            ((Expr2Context)_localctx).tipus =  ((Expr2Context)_localctx).e1.tipus;
			        } else if (((Expr2Context)_localctx).e1.tipus != 'F' && ((Expr2Context)_localctx).e2.tipus != 'F') {
			        ...
			        } else if (((Expr2Context)_localctx).e1.tipus != 'Z' && ((Expr2Context)_localctx).e2.tipus != 'Z') {
			            if(((Expr2Context)_localctx).e1.tipus == 'I'){
			            ...
			            _localctx.trad.add(x.FCMPL);
			            switch (opcio){
			                case 1:
			                    _localctx.trad.add(x.IFGT); // Mes gran
			                    break;
			                case 2:
			                    _localctx.trad.add(x.IFGE); // Mes gran igual
			                    break;
			                case 3:
			                    _localctx.trad.add(x.IFLT); // Mes petit
			                    break;
			                case 4:
			                    _localctx.trad.add(x.IFLE); // Mes petit igual
			                    break;
			                case 5:
			                    _localctx.trad.add(x.IFEQ); // iguals
			                    break;
			                case 6:
			                    _localctx.trad.add(x.IFNE); // diferents
			                    break;
			            }
			            ...
			            notifyErrorListeners((((Expr2Context)_localctx).e1!=null?(((Expr2Context)_localctx).e1.start):null), "Can't evaluate bool and float", null);
			        }
